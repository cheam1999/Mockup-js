    ...
    return (
        <div>
            <div className="description mb-3">
                ...
                <p className="mb-2">
                    Please update with the properity if your travel plans should
                    change or if you wish to make any changes to your stay.
                </p>
                <a href="/">
                    <FaChevronRight />
                ...
                <div className="container bg-white p-2 br-sm border-bottom-right border-bottom-left">
                    <div className="row-grid">
                        ...
                        <div className="col-11 column-grid pl-2 pr-5">
                            ...
                            <div className="row-6">
                                <p>
                                    Please make sure these details are up to
                                    date as they’ll be used for your bookings,
                ...
                <form action="/acc.html" className="container p-2">
                    <div className="row-grid ">
                        <div className="form-grid">
                            <label className="name-label form_label">
                                Your Name
                            </label>{" "}
                            <input
                                type="text"
                        ...
                        <div className="form-grid">
                            <label className="email-label form_label">
                                Email address
                            </label>{" "}
                            <input
                                type="email"
                    ...
                    <div className="row-grid form-table pb-2">
                        <div className="form-grid">
                            <label className="country-label form_label">
                                Country
                            </label>
                            <select
                                className="form_input"
